...
const fetchProductionSchedule = async (): Promise<ProductionJob[]> => {
...
const ProductionSchedule: React.FC = () => {
  ...
  useEffect(() => {
    fetchProductionSchedule().then(setJobs);
  }, []);

  return (
    <div className="mt-10">
      <h2 className="text-lg font-semibold mb-4">Upcoming Production Schedule</h2>
